...
API_KEY = "8KJfr1RRf5IDH_aMIybFQhfX42cUkQJUop2JeXBSboiK"
...
def predict():
    if request.method=="POST":
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/cd840077-9983-4f15-89c4-3f4d83ba4137/predictions?version=2022-11-19', json=payload_scoring,
    ...
    return render_template("result.html" ,y=ans)
